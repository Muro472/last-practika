...
const state = reactive([
  {
    label: categories[0],
    photo: homeAssets[categories[0]],
  },
  {
    label: categories[1],
    photo: homeAssets[categories[1]],
  },
  {
    label: categories[2],
    photo: homeAssets[categories[2]],
  },
  {
    label: categories[3],
    photo: homeAssets[categories[3]],
  },
  {
    label: categories[4],
    photo: homeAssets[categories[4]],
  },
  {
    label: categories[5],
    photo: homeAssets[categories[5]],
  },
  // {
  //   label: categories[6],
  //   photo: homeAssets[categories[6]],
  // },
]);
